...
export const enum IpcEvents {
    GET_GHOSTCORD_PRELOAD_FILE = "VCD_GET_VC_PRELOAD_FILE",
    GET_GHOSTCORD_RENDERER_SCRIPT = "VCD_GET_VC_RENDERER_SCRIPT",
    ...
    GET_GHOSTCORD_DIR = "VCD_GET_GHOSTCORD_DIR",
    SELECT_GHOSTCORD_DIR = "VCD_SELECT_GHOSTCORD_DIR",

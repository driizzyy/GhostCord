...
import { GhostCordNative } from "./GhostCordNative";

contextBridge.exposeInMainWorld("GhostCordNative", GhostCordNative);

require(ipcRenderer.sendSync(IpcEvents.GET_GHOSTCORD_PRELOAD_FILE));

webFrame.executeJavaScript(ipcRenderer.sendSync(IpcEvents.GET_GHOSTCORD_RENDERER_SCRIPT));

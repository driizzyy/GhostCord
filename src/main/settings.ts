...
import { DATA_DIR, GHOSTCORD_SETTINGS_FILE } from "./constants";
...
export const Settings = loadSettings<TSettings>(SETTINGS_FILE, "DriizzyyB settings");
export const GhostCordSettings = loadSettings<any>(GHOSTCORD_SETTINGS_FILE, "DriizzyyB settings");
export const State = loadSettings<TState>(STATE_FILE, "DriizzyyB state");

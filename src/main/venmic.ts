...
import type { LinkData, Node, PatchBay as PatchBayType } from "@ghostcord/venmic";
...
function importVenmic() {
    ...
    try {
        PatchBay = (require(join(STATIC_DIR, `dist/venmic-${process.arch}.node`)) as typeof import("@ghostcord/venmic"))
            .PatchBay;

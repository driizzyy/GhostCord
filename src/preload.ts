...
if (location.protocol !== "data:") {
    // #region cssInsert
    const rendererCss = join(__dirname, IS_VESKTOP ? "ghostcordDesktopRenderer.css" : "renderer.css");

    const style = document.createElement("style");
    style.id = "ghostcord-css-core";
    ...
    if (IS_DEV) {
        ...
        watch(rendererCss, { persistent: false }, () => {
            document.getElementById("ghostcord-css-core")!.textContent = readFileSync(rendererCss, "utf-8");
        });
    }
    // #endregion
